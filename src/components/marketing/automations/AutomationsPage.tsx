...
// decorative, so which automation lands on which color has no meaning.
const CARD_THEMES = [
  { bg: '#eef2ff', fg: '#4f46e5' },
  { bg: '#ecfdf5', fg: '#059669' },
  { bg: '#fff7ed', fg: '#d97706' },
    ...
    <div className="p-4 md:p-6 space-y-5">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight mt-1">Marketing Automations</h1>
          <p className="text-muted-foreground text-sm mt-1">Build behavioural, lifecycle and trip-based journeys using live ERP data.</p>
        </div>
      ...
      <div className="border rounded-xl bg-white p-5 flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="font-semibold">Marketing Automations</h2>
