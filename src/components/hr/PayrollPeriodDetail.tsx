...
const EDIT_FIELDS = [
  ...
  // Custom amount HR sets on the employee's profile — no longer derived from the BPJS
  // employer-contribution fields below (those are tracked separately, employer-cost only).
  { key: 'benefitBpjsAndTax', label: 'Benefit', group: 'earning' },
