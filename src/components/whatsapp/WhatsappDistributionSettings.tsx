...
export default function WhatsappDistributionSettings() {
  ...
  async function save() {
    ...
    try {
      ...
      toast.success('WhatsApp distribution saved')
      await load()
    } catch (e) {
    ...
    <div className="max-w-2xl mx-auto space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Choose which sales reps get new WhatsApp chats, and how they're split. A number that has messaged
          before always stays with the same sales rep — this only applies to brand-new numbers.
        </p>
      </div>
