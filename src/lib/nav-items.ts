...
export const navigationItems: NavItem[] = [
  ...
  { id: 'sales-pipeline', label: 'Sales Pipeline',  icon: Kanban,     roles: ['ADMIN', 'SALES'],                         group: 'operations' },
  ...
  { id: 'marketing-campaign-hub',   label: 'Campaigns',        icon: Target,          roles: ['ADMIN', 'MARKETING'],    group: 'marketing', feature: 'marketing' },
  ...
  // Temporary onboarding-only menu — see memory project-initial-stock-opname-temporary.
  // Intentionally excludes PURCHASING/WAREHOUSE: no approval step, so access is Admin/Finance Director only.
  { id: 'purchasing-initial-stock-opname', label: 'Stock Opname Awal', icon: PackagePlus, roles: ['ADMIN', 'SUPER_ADMIN', 'FINANCE_DIRECTOR'], group: 'purchasing', feature: 'purchasing' },
  ...
  { id: 'hr-separation', label: 'Separation', icon: UserX, roles: ['ADMIN', 'SUPER_ADMIN', 'HR'],                          group: 'hr'    },
]
