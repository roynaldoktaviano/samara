      ...
      for (const recipientId of invoiceReadyTargets) {
        db.notification.upsert({
          ...
          create: {
            userId:    recipientId,
            type:      'INVOICE_READY',
            title:     'Invoice ready to download',
            body:      `${invoiceNumber} (${existing.booking.bookingCode}) has been generated by Finance`,
            paymentId: id,
        ...
        if (recipientUserId) {
          db.notification.upsert({
            ...
            create: {
              ...
              body:      `${payment.invoiceNumber} (${payment.booking.bookingCode}) has been confirmed by ${actorName}`,
              paymentId: id,
        ...
        if (recipientUserId) {
          db.notification.upsert({
            ...
            create: {
              ...
              body:      `${payment.invoiceNumber} (${payment.booking.bookingCode}) has been rejected by ${actorName}`,
              paymentId: id,
              bookingId: payment.bookingId,
            },
            update: {
